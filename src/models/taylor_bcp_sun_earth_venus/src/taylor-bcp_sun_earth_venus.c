 ...
 *
 * It needs the header file 'taylor-bcp_sun_earth_venus.h' to compile.
 * Run taylor with the -header -o taylor-bcp_sun_earth_venus.h option to generate a sample 'taylor-bcp_sun_earth_venus.h'
...
/* series end */
    ...
    if (_jz_maxOrderUsed < order )  { 
	 ...
	 /* const: c_033=2.447824993713855e-6 */
	 MakeMyFloatC(_jz_cvars[9],"2.447824993713855e-6",(double)2.447824993713855e-6);
	 /* const: c_037=0.723332 */
	 MakeMyFloatC(_jz_cvars[10],"0.723332",(double)0.723332);
	 /* mult: c_068=(c_037*c_037) */
	 MultiplyMyFloatA(_jz_cvars[11], _jz_cvars[10], _jz_cvars[10]);
	 /* const: c_039=1.4358367902321345 */
	 MakeMyFloatC(_jz_cvars[12],"1.4358367902321345",(double)1.4358367902321345);
	 /* const: c_035=0.6255137690094534 */
	 MakeMyFloatC(_jz_cvars[13],"0.6255137690094534",(double)0.6255137690094534);
	 /* negate: c_099=(-c_037) */
	 NegateMyFloatA(_jz_cvars[14],_jz_cvars[10]);
	 /* mult: c_069=(c_037*c_068) */
	 MultiplyMyFloatA(_jz_cvars[15], _jz_cvars[10], _jz_cvars[11]);
	 /* div: c_070=(c_033/c_069) */
	 DivideMyFloatA(_jz_cvars[16], _jz_cvars[9], _jz_cvars[15]);
    }
...
/* series end */
	 ...
	 MultiplyMyFloatA(_jz_jet[30][0], _jz_cvars[13], _jz_jet[6][0]);
	 /* plus: v_096=(c_039+v_095) */
	 AddMyFloatA(_jz_jet[31][0], _jz_cvars[12], _jz_jet[30][0]);
	 ...
	 MultiplyMyFloatA(_jz_jet[36][0], _jz_cvars[14], _jz_jet[33][0]);
	 ...
	 MultiplyFloatJetA(_sjz_jet[32][0], MakeMyFloatB(_jz_uvar1,(double)_jz_ivars[1]), _sjz_jet[31][0]);
	 ...
	 MultiplyMyFloatA(_jz_jet[47][0], _jz_cvars[16], _jz_jet[34][0]);
	 ...
	 MultiplyMyFloatA(_jz_jet[56][0], _jz_cvars[16], _jz_jet[36][0]);
	 ...
	 for(_jz_k = _jz_lastOrder; _jz_k < order; _jz_k++) {
		 ...
		 /* mult: v_095=(c_035*v_028) */
		 if(_jz_k==1) {AssignMyFloat(_jz_jet[30][_jz_k], _jz_cvars[13]);}
		 ...
		 { /* call cos sin */
			 ...
			 DivideMyFloatA(tmp, _jz_cvars[13], _jz_theNs[_jz_k]);
		 ...
		 /* mult: v_103=(c_099*v_102) */
		 MultiplyMyFloatA(_jz_jet[36][_jz_k], _jz_cvars[14], _jz_jet[33][_jz_k]);
		 /* mult: v_106=(v_023*v_103) */
		 { /* multiplication */
			 static MY_FLOAT tmp1, tmp2, tmp;
			 #pragma omp threadprivate(tmp1, tmp2, tmp)
		 ...
		 /* mult: v_108=(i_045*v_107) */
		 MultiplyFloatJetA(_sjz_jet[32][_jz_k], MakeMyFloatB(_jz_tvar1,(double)_jz_ivars[1]), _sjz_jet[31][_jz_k]);
		 /* minus: v_109=(v_075-v_108) */
		 ...
		 /* mult: v_128=(c_070*v_098) */
		 MultiplyMyFloatA(_jz_jet[47][_jz_k], _jz_cvars[16], _jz_jet[34][_jz_k]);
		 /* minus: v_129=(v_127-v_128) */
		 ...
		 /* mult: v_140=(c_070*v_103) */
		 MultiplyMyFloatA(_jz_jet[56][_jz_k], _jz_cvars[16], _jz_jet[36][_jz_k]);
		 /* minus: v_141=(v_139-v_140) */

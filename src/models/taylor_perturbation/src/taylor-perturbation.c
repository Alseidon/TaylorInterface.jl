 ...
 *
 * It needs the header file 'taylor-perturbation.h' to compile.
 * Run taylor with the -header -o taylor-perturbation.h option to generate a sample 'taylor-perturbation.h'
    ...
    if (rflag == 0) {
	 ...
	 for(_jz_k = _jz_lastOrder; _jz_k < order; _jz_k++) {
		 ...
		 { /* call sin cos */
			 ...
			 DivideMyFloatA(tmp, freq[_jz_ivars[0]], _jz_theNs[_jz_k]);
		 ...
		 { /* call sin cos */
			 ...
			 DivideMyFloatA(tmp, freq[_jz_ivars[1]], _jz_theNs[_jz_k]);
		 ...
		 { /* call sin cos */
			 ...
			 DivideMyFloatA(tmp, freq[_jz_ivars[2]], _jz_theNs[_jz_k]);
		 ...
		 { /* call sin cos */
			 ...
			 DivideMyFloatA(tmp, freq[_jz_ivars[3]], _jz_theNs[_jz_k]);
		 ...
		 { /* call sin cos */
			 ...
			 DivideMyFloatA(tmp, freq[_jz_ivars[4]], _jz_theNs[_jz_k]);
		 ...
		 { /* call sin cos */
			 ...
			 DivideMyFloatA(tmp, freq[_jz_ivars[5]], _jz_theNs[_jz_k]);
		 ...
		 { /* call sin cos */
			 ...
			 DivideMyFloatA(tmp, freq[_jz_ivars[6]], _jz_theNs[_jz_k]);
		 ...
		 { /* call sin cos */
			 ...
			 DivideMyFloatA(tmp, freq[_jz_ivars[7]], _jz_theNs[_jz_k]);
		 ...
		 { /* call sin cos */
			 ...
			 DivideMyFloatA(tmp, freq[_jz_ivars[8]], _jz_theNs[_jz_k]);
		 ...
		 { /* call sin cos */
			 ...
			 DivideMyFloatA(tmp, freq[_jz_ivars[9]], _jz_theNs[_jz_k]);
		 ...
		 _jz_m = _jz_k+1;
		 /* state variable 0: */
		 DivideMyFloatA(_jz_jet[0][_jz_m], _jz_jet[3][_jz_k], _jz_theNs[_jz_m]);
		 /* state variable 1: */
		 DivideMyFloatA(_jz_jet[1][_jz_m], _jz_jet[55][_jz_k], _jz_theNs[_jz_m]);
		 _jz_initialized=1;
	 }
    _jz_lastOrder = order;
    _jz_ginitialized=1;
